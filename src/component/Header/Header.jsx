...
//instead of using anchor tag we use link bcz wo page ko refresh nhi krta hai 
                            ...
                            <li>
                                ...
                                to="/about"
                                    className={({isActive}) =>
                                     ...
                                     border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 
                                     lg:p-0`
                                    }
                                >
                                    About
